...
<div id="dlg" class="easyui-dialog" style="width: 420px; height: 400px; padding: 10px 20px;"
    ...
    <form id="fm" method="post">
        ...
        <ul>
            <li class="labelLi"><label>A选项<span class="redStar">*</span></label></li>
            <li class="inputLi"><input name="keya" class="easyui-validatebox" required="true" /></li>
        </ul>
        <ul>
            <li class="labelLi"><label>B选项<span class="redStar">*</span></label></li>
            <li class="inputLi"><input name="keyb" class="easyui-validatebox" required="true" /></li>
        </ul>
        <ul>
            <li class="labelLi"><label>C选项<span class="redStar">*</span></label></li>
            <li class="inputLi"><input name="keyc" class="easyui-validatebox" required="true" /></li>
        </ul>
        <ul>
            <li class="labelLi"><label>D选项<span class="redStar">*</span></label></li>
            <li class="inputLi"><input name="keyd" class="easyui-validatebox" required="true" /></li>
        </ul>
        <ul>
        ...
        <input type="hidden" name="choiceQuestionId" id="choiceQuestionId" />
    </form>
</div>
<div id="dlg-buttons">
